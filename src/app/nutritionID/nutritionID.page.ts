...
@Component({
  selector: 'app-nutritionID',
  templateUrl: 'nutritionID.page.html',
  styleUrls: ['nutritionID.page.scss']
})
export class NutritionIDPage {
  nutritionData = {
    name: '',
    etape:'',
    tempTotal:'',
  ...
  constructor(private http : HttpClient) {
    this.http.get(this.url,{'headers': this.headers}).subscribe((data)=>{
      this.nutritionData = data['recettes'][0]
    })
  }
